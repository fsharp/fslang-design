...
See [coroutineBasic.fs](https://github.com/dotnet/fsharp/blob/feature/tasks/tests/fsharp/perf/tasks/TaskPerf/coroutineBasic.fs).
...
See [coroutine.fs](https://github.com/dotnet/fsharp/blob/feature/tasks/tests/fsharp/perf/tasks/TaskPerf/coroutine.fs).
...
See [taskSeq.fs](https://github.com/dotnet/fsharp/blob/feature/tasks/tests/fsharp/perf/tasks/TaskPerf/taskSeq.fs).
...
* Implementation: https://github.com/dotnet/fsharp/blob/feature/tasks/tests/fsharp/perf/tasks/TaskPerf/async2.fs

* Signature fle: https://github.com/dotnet/fsharp/blob/feature/tasks/tests/fsharp/perf/tasks/TaskPerf/async2.fsi
