...
See also [the overall status of F# 4.0+ Language Design Items](https://visualfsharp.codeplex.com/wikipage?title=Status).
...
| mapFold       | New, map + fold, with signature ```mapFold : ('State -> 'T -> 'U * 'State) -> 'State -> C<'T> -> C<'U> * 'State``` e.g. [see here](https://github.com/fsharp/fsharp/blob/8c82d57a6e8cc131740316b00f199d9d48072346/src/absil/illib.fs#L77)          |   ADD       |    ADD      |     ADD    |   [PR](https://visualfsharp.codeplex.com/SourceControl/network/forks/PatrickMcDonald/visualfsharp/contribution/7399)       |      under review     |
| mapFoldBack       | New, map + fold, with signature ```mapFoldBack : ('T -> 'State -> 'U * 'State) -> C<'T> -> 'State -> C<'U> * 'State``` |   ADD       |    ADD      |     ADD    |   [PR](https://visualfsharp.codeplex.com/SourceControl/network/forks/PatrickMcDonald/visualfsharp/contribution/7399)       |        under review   |
| max        |           |    o      | o         |  o       |   done       |     :)     |
| maxBy      |           |    o      | o         |    o     |   done       |     :)     |
| min        |           |  o        |         o |  o       |   done       |     :)     |
| minBy      |           |    o      |   o       |    o     |   done       |     :)     |
...
| tryPick    |           |    o      |  o        | o        |   done       | :)         |
| unfold     |           |    ADD    | ADD       |  o       |   [PR](https://visualfsharp.codeplex.com/SourceControl/network/forks/PatrickMcDonald/visualfsharp/contribution/7409)       |       :)    |
| where      | syn. filter |  ADD    |  ADD      |  o       |  [PR](https://visualfsharp.codeplex.com/SourceControl/network/forks/forki/fsharp/contribution/7037)        | :) |
| windowed   |           |    ADD    |  ADD      |  o       |   [PR](https://visualfsharp.codeplex.com/SourceControl/network/forks/PatrickMcDonald/visualfsharp/contribution/7419)       |    :)      |
| zip        |           |    o      |  o        |  o       |   done       |   :)       |
| zip3       |           |    o      |  o        |  o       |   done       |   :)       |
